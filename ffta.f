...
c ffta => Base case
c
      subroutine ffta ( d, lens, ndim, coeff, irev )
c
...
c
      ...
      write(*,'(a,t15,f10.6)')'Coeffs, etc.',seconds(times)
c
...
c dir: ignore recrdeps(d)
         ...
         enddo
      write(*,'(a,t15,f10.6)')'Bit reversal',seconds(times)
c
...
c dir: ignore recrdeps(d)
	       ...
	       d(i+lip+lopfac) = d(2*i+lop)-temp
            enddo
         enddo
      write(*,'(a,t15,f10.6)')'Radix 2',seconds(times)
      enddo
c
...
c dir: ignore recrdeps(d)
	 do i = 0, lentot - 1
	    d(i) = d(i+lip)
         enddo
      write(*,'(a,t15,f10.6)')'Copy to top',seconds(times)
      endif
c 
c Done
c
