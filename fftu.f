...
c fftu => Do radix-32 as radix-4s and radix-2
c
      subroutine fftu ( d, lens, ndim, coeff, irev )
c
...
c in-place algorithm. Implemented as two radix-4 followed by a radix-2.
c Of course, each radix-4 is done as two radix-2s.
c
c dir: prefer vector
c dir: ignore recrdeps(d)
               do i = 0, lopfac - 1
                  iw = if1*int(i/if2)
                  k = 32*i+lop
c Twiddle, bit reverse, and do first radix-4 butterfly
c First set of 4
                  t00  = d(k   )
                  ...
                  t03  = temp - t03
c Second set of 4
                  t04  = d(k+ 4)*coeff( 4*iw)
                  t05  = d(k+20)*coeff(20*iw)
                  temp = t04
                  t04  = temp + t05
                  t05  = temp - t05
                  t06  = d(k+12)*coeff(12*iw)
                  ...
                  t04  = temp + t06
                  t06  = temp - t06
                  t06  = coeff(4*lensidim/16)*t06
                  temp = t05
                  t05  = temp + t07
                  t07  = temp - t07
                  t05  = coeff(2*lensidim/16)*t05
                  t07  = coeff(6*lensidim/16)*t07
c Third set of 4
                  t08  = d(k+ 2)*coeff( 2*iw)
                  t09  = d(k+18)*coeff(18*iw)
                  temp = t08
                  t08  = temp + t09
                  t09  = temp - t09
                  t10  = d(k+10)*coeff(10*iw)
                  ...
                  t08  = temp + t10
                  t10  = temp - t10
                  t10  = coeff(2*lensidim/16)*t10
                  temp = t09
                  t09  = temp + t11
                  t11  = temp - t11
                  t09  = coeff(1*lensidim/16)*t09
                  t11  = coeff(3*lensidim/16)*t11
c Fourth set of 4
                  t12  = d(k+ 6)*coeff( 6*iw)
                  t13  = d(k+22)*coeff(22*iw)
                  temp = t12
                  t12  = temp + t13
                  t13  = temp - t13
                  t14  = d(k+14)*coeff(14*iw)
                  ...
                  t12  = temp + t14
                  t14  = temp - t14
                  t14  = coeff(6*lensidim/16)*t14
                  temp = t13
                  t13  = temp + t15
                  t15  = temp - t15
                  t13  = coeff(3*lensidim/16)*t13
                  t15  =-coeff(  lensidim/16)*t15
c Fifth set of 4
                  t16  = d(k+ 1)*coeff(   iw)
                  ...
                  t19  = temp - t19
c Sixth set of 4
                  t20  = d(k+ 5)*coeff( 5*iw)
                  t21  = d(k+21)*coeff(21*iw)
                  temp = t20
                  t20  = temp + t21
                  t21  = temp - t21
                  t22  = d(k+13)*coeff(13*iw)
                  ...
                  t20  = temp + t22
                  t22  = temp - t22
                  t22  = coeff(4*lensidim/16)*t22
                  temp = t21
                  t21  = temp + t23
                  t23  = temp - t23
                  t21  = coeff(2*lensidim/16)*t21
                  t23  = coeff(6*lensidim/16)*t23
c Seventh set of 4
                  t24  = d(k+ 3)*coeff( 3*iw)
                  t25  = d(k+19)*coeff(19*iw)
                  temp = t24
                  t24  = temp + t25
                  t25  = temp - t25
                  t26  = d(k+11)*coeff(11*iw)
                  ...
                  t24  = temp + t26
                  t26  = temp - t26
                  t26  = coeff(2*lensidim/16)*t26
                  temp = t25
                  t25  = temp + t27
                  t27  = temp - t27
                  t25  = coeff(1*lensidim/16)*t25
                  t27  = coeff(3*lensidim/16)*t27
c Eighth set of 4
                  t28  = d(k+ 7)*coeff( 7*iw)
                  t29  = d(k+23)*coeff(23*iw)
                  temp = t28
                  t28  = temp + t29
                  t29  = temp - t29
                  t30  = d(k+15)*coeff(15*iw)
                  ...
                  t28  = temp + t30
                  t30  = temp - t30
                  t30  = coeff(6*lensidim/16)*t30
                  temp = t29
                  t29  = temp + t31
                  t31  = temp - t31
                  t29  = coeff(3*lensidim/16)*t29
                  t31  =-coeff(  lensidim/16)*t31
c Second radix-4 butterfly
c First set of 4
                  temp = t00
                  t00  = temp + t04
                  t04  = temp - t04
...
c Finish with a radix-2 butterfly
                  d(i+lip          ) = t00 + t16
                  d(i+lip+16*lopfac) = t00 - t16
                  d(i+lip+ 1*lopfac) = t01 + t17
